...
static void gl_free(void* p) { FreePool(p); }
static void* gl_malloc(GLint size) { return AllocatePool(size); }
static void* gl_zalloc(GLint size) { return AllocateZeroPool(size); }
#else
#include<string.h>
#include<stdlib.h>
